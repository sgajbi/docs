...
| Technical knowledge | `docs/technical/` | Architecture boundaries, backend service structure, API governance, data products, CI/CD, observability, SRE, security, testing, resilience. |
