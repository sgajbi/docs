...
Use it when designing proposal workflows, mandate checks, portfolio-review views, client statements, risk reports, exception queues, data-quality rules, or regression scenarios. It is intentionally platform-neutral and should be adapted to the target policy, jurisdiction, product catalogue, and source-system contracts.
