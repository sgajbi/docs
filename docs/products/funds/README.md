...
| `05-worked-examples-and-implementation-patterns.md` | Provides practical examples for subscriptions, cut-offs, NAV confirmation, redemptions, gates, distributions, share classes, ETFs, look-through, private funds, NAV restatements, equalization, conversions, mergers, re-registration, suspensions, eligibility changes, tax-status changes, rebates, levy disputes, side-pocket exits, closure distributions, master-feeder restructures, liquidity stress, recallable distributions, ETF market-maker stress, cross-border share-class restrictions, administrator restatements, tax-lot migration and QA. |
