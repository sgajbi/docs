...
| Structured notes | [`structured-notes/`](structured-notes/README.md) | [`fixed-income-and-structured-products.md`](fixed-income-and-structured-products.md) | Strong coverage of structured-note taxonomy, lifecycle, payoff terms, barriers, autocalls, valuation, risk, physical settlement, advisory, and QA. | Add payoff-state examples and a source-ownership guide for issuer terms, observations, underlyings, valuation, and lifecycle events. |
