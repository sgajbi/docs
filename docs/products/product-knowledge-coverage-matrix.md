...
|---|---|---|---|---|
| Bonds | [`bonds/`](bonds/README.md) | [`fixed-income-and-structured-products.md`](fixed-income-and-structured-products.md) | Strong coverage of bond taxonomy, lifecycle, accrued interest, yield, duration, credit risk, valuation, controls, and QA. Cross-product examples now include callable yield-to-worst and downgrade/collateral haircut treatment. | Add a deeper issuer/credit-events source-ownership matrix and client-reporting examples for maturity ladder, yield, duration, spread exposure, and default/recovery. |
...
| Derivatives | [`derivatives/`](derivatives/README.md) | [`derivatives-and-overlay-products.md`](derivatives-and-overlay-products.md) | Strong coverage of options, futures, forwards, swaps, CDS, valuation, Greeks, exposure, margin, collateral, mandate controls, and QA. Cross-product examples now include FX forward hedge and futures variation margin versus notional exposure. | Add product-by-product exposure measure examples and a margin/collateral accounting versus performance treatment guide for options, swaps, CDS, and OTC structures. |
| Equities | [`equities/`](equities/README.md) | [`direct-equities-and-market-operations.md`](direct-equities-and-market-operations.md) | Strong coverage of direct equity lifecycle, settlement, corporate actions, cost basis, P&L, performance, risk, and market operations. Cross-product examples now include dividend tax, rights issue, settlement funding, and Brinson attribution context. | Add a corporate-action processing decision tree and source-ownership model for issuer, exchange, custodian, tax-lot ledger, and market-data inputs. |
| Funds | [`funds/`](funds/README.md) | [`pooled-investment-products.md`](pooled-investment-products.md) | Strong coverage of fund taxonomy, share classes, order lifecycle, NAV, fees, distributions, look-through, risk, and private fund flows. Cross-product examples now include fund gates, cut-off timing, stale NAV, and partial redemption. | Add a dedicated dealing-calendar/cut-off workflow map and explicit treatment for suspensions, side pockets, look-through coverage quality, and UI/API states. |
...
| Trusts, estate planning, family office and wealth structuring | [`trusts-estate-family-office-wealth-structuring/`](trusts-estate-family-office-wealth-structuring/README.md) | [`wealth-structuring-trusts-and-family-office.md`](wealth-structuring-trusts-and-family-office.md) | Strong coverage of trusts, foundations, estates, family offices, holding vehicles, beneficial ownership, authority, reporting hierarchy, mandates, access control, governance, implementation, and QA. Cross-product examples now include family-office consolidated reporting with authority limits and restricted data. | Add worked examples for trust distribution, estate freeze, holding-company pledge, beneficiary access, and policy ownership roles. |
