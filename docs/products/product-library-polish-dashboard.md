...
2. bond repo margin calls, callable make-whole disputes, benchmark-index bond removals, post-default restructuring packages and portfolio-level spread hedge overlays,
