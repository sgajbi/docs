...
4. derivative wrong-way risk, collateral interest and settlement fails, fallback-rate transition, option lifecycle amendments and hedge-accounting evidence examples,
