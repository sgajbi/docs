...
1. FX swap rollover failures, deposit early-break approval disputes, virtual-account cash allocation, payment rail outage rerouting, treasury concentration-limit breaches and stale bank-balance certification,
2. fallen-angel index migration, callable notice timing disputes, bond tender proration disputes, inflation-linked deflation floors, ESG covenant step-ups and bond option exercise errors,
3. private-fund continuation vehicle elections, ETF authorized-participant concentration failure, fund tax-character restatement after year end, UCITS concentration breach remediation, private-credit fund PIK income reporting and fund distribution clawback notices,
4. collateral rehypothecation restrictions, FX barrier digital payout disputes, option auto-exercise thresholds, cleared margin model migrations, swaption exercise settlement and total return swap corporate-action basket adjustments,
5. direct-property easement disputes, REIT rights issue underwriting failures, infrastructure inflation-index lag, property tax appeal settlements, renewable repowering capex and data-centre tenant power default,
6. treaty-rate expiry at payment date, nominee withholding statements, tax voucher correction chains, portfolio transfer year-end statements, withholding-rate override governance and cross-border report suppression rules,
