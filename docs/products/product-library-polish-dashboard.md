...
3. fund liquidity facility drawdowns, redemption-in-kind stress baskets, stale private-fund capital-account statements, manager replacement and side-pocket write-off examples,
