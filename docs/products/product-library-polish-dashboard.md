...
1. deposit ladder repricing during rate shocks, multi-currency payment recall, booking-centre cash segmentation, intraday overdraft escalation and treasury sweep exception reporting,
