...
2. floating-rate fallback transition, callable tender reoffer, cross-currency bond hedging effectiveness, collateral eligibility downgrades, bond option-adjusted spread model changes and tax-lot portability after custody transfer,
