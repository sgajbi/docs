...
|---|---|---|
| Bonds | [`bonds/05-worked-examples-and-implementation-patterns.md`](bonds/05-worked-examples-and-implementation-patterns.md) | Clean/dirty settlement, accrued interest, yield, duration, callable bonds, downgrade impact, maturity ladders, default/recovery, inflation-linked uplift, amortising schedules, convertible exposure, asset-backed prepayments and multi-currency performance. |
