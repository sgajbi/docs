...
| Vendor and third-party risk | [`vendor-management-third-party-risk/`](vendor-management-third-party-risk/README.md) | Govern vendor intake, outsourcing, procurement, due diligence, contract controls, exit planning and bank-buyable software evidence. |
...
| Business strategy and transformation | [`wealth-business-strategy-operating-model-transformation/`](wealth-business-strategy-operating-model-transformation/README.md) | Connect business strategy, target operating model, roadmap, governance, value realization and executive communication. |
| Commercial model | [`commercial-saas-pricing-enterprise-sales/`](commercial-saas-pricing-enterprise-sales/README.md) | Shape packaging, pricing, enterprise sales, contracts, customer success, support and value realization. |
...
| Knowledge-base operating layer | [`knowledge-base-master-index-roadmap-playbook/`](knowledge-base-master-index-roadmap-playbook/README.md) | Maintain navigation, learning paths, sharing routines, quality rubric, tags and repository standards. |
...
| How should a vendor, SaaS provider, data provider or AI tool pass bank intake? | [`vendor-management-third-party-risk/`](vendor-management-third-party-risk/README.md) | Security reference, delivery reference, commercial SaaS reference. |
| How should a product capability become a credible enterprise commercial offer? | [`commercial-saas-pricing-enterprise-sales/`](commercial-saas-pricing-enterprise-sales/README.md) | Vendor-risk reference, business strategy reference, delivery reference. |
| How should a transformation roadmap, operating model or executive pack be structured? | [`wealth-business-strategy-operating-model-transformation/`](wealth-business-strategy-operating-model-transformation/README.md) | Architecture reference, product framework, AI product strategy, delivery reference. |
