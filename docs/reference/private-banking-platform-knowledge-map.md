...
| [`../products/portfolio-construction-and-rebalancing-guide.md`](../products/portfolio-construction-and-rebalancing-guide.md) | Portfolio construction and rebalancing standard for target allocation, drift, funding, liquidity, tax/cost impact, mandates, execution readiness, reporting, and QA. |
| [`../products/portfolio-exposure-modelling-guide.md`](../products/portfolio-exposure-modelling-guide.md) | Portfolio exposure standard for legal holdings, market value, look-through, notional, sensitivity, issuer, counterparty, currency, liquidity, collateral, commitment, mandate, and reporting views. |
| [`private-banking-operating-model/`](private-banking-operating-model/README.md) | Consolidated operating-model standards for performance measurement, advisory, DPM, suitability, execution, custody, corporate actions, lending, controls, and QA. |
