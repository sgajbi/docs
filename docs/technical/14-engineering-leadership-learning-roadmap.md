...
| 3 | [`05-ci-cd-quality-gates-and-release-governance.md`](05-ci-cd-quality-gates-and-release-governance.md), [`cicd-devsecops-release-evidence/`](cicd-devsecops-release-evidence/README.md), [`08-testing-performance-and-resilience.md`](08-testing-performance-and-resilience.md) | Identify local quality commands and classify tests into unit, integration and E2E. |
| 4 | [`06-observability-sre-and-operational-support.md`](06-observability-sre-and-operational-support.md), [`observability-sre-supportability/`](observability-sre-supportability/README.md), [`07-security-configuration-and-sensitive-data.md`](07-security-configuration-and-sensitive-data.md) | Review one runbook or service README for health checks, logs, metrics, secrets and supportability. |
...
| 7 | [`10-infrastructure-containers-and-deployment.md`](10-infrastructure-containers-and-deployment.md) and [`runtime-infrastructure-kubernetes/`](runtime-infrastructure-kubernetes/README.md) | Review one Dockerfile or compose file for runtime, health, ports, secrets and startup posture. |
