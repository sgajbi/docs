...
| 2 | [`02-backend-application-structure.md`](02-backend-application-structure.md), [`03-api-contract-governance.md`](03-api-contract-governance.md) | Trace one endpoint from route to service to repository/client to response model. |
...
| 12 | Re-read [`01-architecture-and-service-boundaries.md`](01-architecture-and-service-boundaries.md), [`05-ci-cd-quality-gates-and-release-governance.md`](05-ci-cd-quality-gates-and-release-governance.md), [`16-practitioner-review-prompts-and-checklists.md`](16-practitioner-review-prompts-and-checklists.md) and [`17-implementation-evidence-reading-map.md`](17-implementation-evidence-reading-map.md) | Write an architecture or delivery review for a proposed change. |
