...
| Calibrate answer quality for labs | [`technical-practice-lab-sample-answers.md`](technical-practice-lab-sample-answers.md) |
...
Use [`technical-practice-lab-sample-answers.md`](technical-practice-lab-sample-answers.md) to calibrate what a good evidence-backed lab answer should contain before using the labs for KT or coaching.
